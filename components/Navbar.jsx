...
const Navbar = () => {
  ...
  return (
    <>
      <header className={`fixed lg:sticky w-full z-[999999999999999]  md:w-9/12 mx-auto top0 md:top-3 transition-all px-3 md:rounded-full duration-300 ${scrolled ? 'bg-white shadow-lg' : 'bg-transparent'}`}>
